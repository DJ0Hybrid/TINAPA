    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriType) {
            ...
            case OWNED_POKEMON:
                ...
                // TODO Select array
                selectionArray = new String[]{"owned_pokemons.id AS _id", "owned_pokemons.nickname AS nickname", "pokemon_species_names.name AS name", "icon_image", "image", "shinny_image", "iv_hp", "iv_att", "iv_def", "iv_satt", "iv_sdef", "iv_spd", "ev_hp", "ev_att", "ev_def", "ev_satt", "ev_sdef", "ev_spd", "level", "shinny", "note", "nature.name AS nature_name"};
                break;
